...
export default function Navigation(view){
    ...
    return(
        <nav className={`pr-3 ${poppins500.className} block absolute top-[50px]  z-50 right-0 bg-white h-screen pt-[70px] pb-5 px-5 pl-[100px] text-right  lg:top-0 lg:pt-0 lg:pb-0 lg:px-0 lg:pl:0 lg:text-start lg:h-fit lg:relative ' }`}>
